 ...
 *
 */
public class SilenceDetectorWithHTreeMap {
    /**
     * 
     */
...
//            StringBuilder sb = new StringBuilder();
			...
			HTreeMap<Long, byte[]> timeBasedAudioInputMap = db.hashMap("long_byte_array_map", Serializer.LONG, Serializer.BYTE_ARRAY).create();
            while (true) {
